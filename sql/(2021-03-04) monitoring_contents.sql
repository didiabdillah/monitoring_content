...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 04, 2021 at 07:35 AM
...
(11, '2021_03_04_100919_create_missed_uploads_table', 2);
...
(1, 'Whatsapp API Not Active', 'Telegram API Not Active', 'dummy.test', '465', 'dummy@email.com', '1234567890', 'default-logo.png', 'default-favicon.ico', '2021-03-02 04:19:05', '2021-03-04 06:23:59');
...
('2bf63fb4904c4efeaee484ce63ba2f44', 'Dev', 'abdillah1965didiokey@gmail.com', '$2y$10$OaDmibcnozh1peTG4JH57uAPuIU3gqCt/htGIi3.6ky1HnSA5AMLa', 0, '087727598653', 'admin', 'Fu47axFbH07JR8ehnZgwoggDZJCzg9VQkByGY2Aj.png', '2021-03-02 04:26:15', '2021-03-02 04:26:15'),
('a5c860decf204ea686aedbb6dbeb6ab1', 'Admin', 'admin@email.com', '$2y$10$OaDmibcnozh1peTG4JH57uAPuIU3gqCt/htGIi3.6ky1HnSA5AMLa', 0, '12345678', 'admin', 'default.jpg', '2021-03-02 04:19:14', '2021-03-04 04:49:00'),
('befd447863294f01920f61b897e617ab', 'Elsa', 'elsa@email.com', '$2y$10$RWzjGmAuygfJLfSwkiETZ.uXz1ROSGmcWfXmwh2nbqPX0Og1H9weq', 2, '0812345678900', 'operator', 'default.jpg', '2021-03-04 06:22:01', '2021-03-04 06:22:01');
...
--
ALTER TABLE `contents`
  MODIFY `content_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `content_files`
--
ALTER TABLE `content_files`
  MODIFY `content_file_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `content_histories`
--
ALTER TABLE `content_histories`
  MODIFY `content_history_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `content_links`
--
ALTER TABLE `content_links`
  MODIFY `content_link_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `holidays`
  MODIFY `holiday_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `missed_uploads`
  MODIFY `missed_upload_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
